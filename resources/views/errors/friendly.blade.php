<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{{ $title }} — Codeza ERP</title>
<style>
...
<body><main><div class="code">Codeza ERP · {{ $status }}</div><h1>{{ $title }}</h1><p>{{ $message }}</p>
